<template>
    <div class="container-fruid" style="overflow-y: scroll;">
        ...
        <div class="modal fade" :id="'todoModal'+goalModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal fade" :id="'todoSortModal'+goalId+todo.id" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-danger" data-dismiss="modal" v-on:click="sortTodo(todo)">Submit</button>
                        </div>
                    </div>
                </div>
            </div>
...
export default {
    ...
    methods: {
        ...
        addNewTodo: function () {
            axios.defaults.headers['X-CSRF_TOKEN'] = $('meta[name=csrf-token]').attr('content');
